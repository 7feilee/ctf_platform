__Local Training Events__
=========================

> John Hammond | September 19th, 2016

------------


In this repository I hope to house all the code and files for any material that I create for a local training event; like some of the practice [CTF] competitions we host right at the [USCGA] for our team and our team alone.

These are not as documented as they should be, and I do hope to at some point write more regarding these files. 
